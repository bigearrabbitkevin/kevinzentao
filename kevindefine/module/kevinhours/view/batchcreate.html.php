...
unset($statusList['doing']);
?>
<center>
	<form id = 'form1' class='form-condensed' method='post' target='hiddenwin'  onsubmit="return submitTest();" style="max-width: 1200px">
		<div id='titlebar'>
			<div class='heading'>
		...
		<div>
			<table class='table k-batch-table' style="width:100%; max-width: 1200px; min-width: 500px;">
				<thead>
					<tr>
				...
				<?php for ($i = 0; $i < $config->kevinhours->batchcreate; $i++):?>
					<tr class='text-center'>
						...
						<td class = 'text-left' id=<?php echo 'projectNameBox' . $i;?>><?php echo html::select("projectName[$i]", $projectsArray, '', "onchange='onChangeProjectName($i)' class='form-control chosen'");?></td>
			...
			<div class="text-left">
				...
				说明：<br>
				<ul>
					<li>『<?php echo $lang->kevinhours->name;?>』：填入工作内容简述。如果不填，任务这条记录无效</li>
					<li>『<?php echo $lang->kevinhours->projectName;?>』 和 『<?php echo $lang->kevinhours->projectId;?>』 是联动的，只要填写一个即可。<br>
						『<?php echo $lang->kevinhours->projectId;?>』：填入项目代号，可以填入禅道项目号，或者付费号<br>
						『<?php echo $lang->kevinhours->projectName;?>』：可以选择有权限的项目或者已经记录过工时的最近几个月的项目。下拉列表没有的项目，只能通过『<?php echo $lang->kevinhours->projectId;?>』输入</li>
					<li>『<?php echo $lang->kevinhours->workhours;?>』 和 『<?php echo $lang->kevinhours->beginAndEnd;?>』 是联动的，只要填写一个即可。<br>
						『<?php echo $lang->kevinhours->workhours;?>』 可以填入1.5 或1:30或 90，都表示1个半小时<br></li>
				</ul>
				<br>
				<br>
			</div>
