...
<div id="mainChart" style="height:500px;border:0px solid #ccc;padding:20px;"></div>
<div>
	<table class='table table-condensed table-hover table-striped tablesorter w-400px' id='kevinplanCountList'>
		...
		<tbody>
			...
			foreach ($items as $item):
				...
				$xData .= "'" . $userlist[$item->XValue] . "'";
				$yData .= $item->YValue;
				$hoursTotal += $item->YValue;
				?>
				<tr class='text-center'>
					<td><?php echo $i;?></td>
					<td class='text-left'><?php echo $userlist[$item->XValue];?></td>
			...
			?>
			<tr class='text-center'>
				<td colspan="3"><?php echo "sum = ". $hoursTotal."h /".$hoursTotal/2000 ."Year" ;?></td>
			</tr>
		</tbody>
	</table>
</div>
