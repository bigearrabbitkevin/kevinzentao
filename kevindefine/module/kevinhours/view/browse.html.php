...
<div class='side'>
  <a class='side-handle' data-id='kevinhoursTree'><i class='icon-caret-left'></i></a>
  <div class='side-body'>
		...
		<?php foreach ($users as $user):
			...
			<tr class='text-center'>
			  ...
			  <td class='text-left' <?php echo $lockbackground;?>>
				  ...
				  if ($isNotAdmin) {
					  $titlelockedNone = $lang->kevinhours->lockedNone . $lang->kevinhours->userLock . "?";
					  $titlelockedTemp = $lang->kevinhours->lockedTemp . $lang->kevinhours->unlock . "?";
					  $titlelockedLong = $lang->kevinhours->lockedLong . $lang->kevinhours->unlock . "?";
