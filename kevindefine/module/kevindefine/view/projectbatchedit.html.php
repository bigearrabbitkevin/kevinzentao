...
<div id='titlebar'>
  <div class='heading'>
    ...
    <strong><small class='text-muted'><?php echo html::icon($lang->icons['batchEdit']);?></small> <?php echo $lang->kevindefine->projectlist . $lang->colon . $lang->project->batchEdit;?></strong>
  </div>
</div>
<form class='form-condensed' method='post' target='hiddenwin' action='<?php echo inLink('projectbatchEdit');?>'>
