...
<?php js::set('confirmDelete', $lang->kevindevice->confirmDelete); ?>
<!-- ECharts单文件引入 -->
	...
	<div class='side-body'>
		<div class='panel panel-sm'>
			...
			<div class='panel-body'>
				<ul class='tree'>
					<?php
					foreach ($this->lang->kevindevice->statisticType as $currentStatisticType => $currentStatisticName) {
						echo '<li>' . html::a(helper::createLink('kevindevice', 'statistic', "type=$currentStatisticType"), $currentStatisticName, '', "class='link'") ;
