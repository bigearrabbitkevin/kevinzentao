...
<div class='container mw-800px'>
	<form class='form-condensed' method='post' target='hiddenwin' id='dataform'>
		...
		<table align='center' class='table table-form'>
			...
			<tr>
				<th><?php echo $lang->kevindevice->repairstart; ?></th>
				<td><?php echo html::input('repairstart', $device->repairstart, "class='form-control form-date'"); ?></td>
				<th><?php echo $lang->kevindevice->repairend; ?></th>
				<td><?php echo html::input('repairend', $device->repairend, "class='form-control form-date'"); ?></td>
			</tr>
		</table>
		<table align='center' class='table table-form'>
