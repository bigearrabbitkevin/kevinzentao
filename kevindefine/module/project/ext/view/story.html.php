...
<div id='featurebar'>
  ...
  <ul class='nav'>
  <?php
	echo "<li id='unclosedTab'>"; common::printLink('project', 'story', "project=$projectID&orderBy=&type=unclosed", $lang->kevindefine->unclosed); echo '</li>' ;
	echo "<li id='allstoryTab'>"; common::printLink('project', 'story', "project=$projectID&orderBy=&type=allstory", $lang->product->allStory); echo  '</li>' ;
	echo "<li id='assignedtomeTab'>"; common::printLink('project', 'story', "project=$projectID&orderBy=&type=assignedtome", $lang->product->assignedToMe); echo  '</li>' ;
	echo "<li id='openedbymeTab'>"; common::printLink('project', 'story', "project=$projectID&orderBy=&type=openedbyme", $lang->product->openedByMe); echo  '</li>' ;
	echo "<li id='reviewedbymeTab'>"; common::printLink('project', 'story', "project=$projectID&orderBy=&type=reviewedbyme", $lang->product->reviewedByMe); echo  '</li>' ;
	echo "<li id='closedbymeTab'>"; common::printLink('project', 'story', "project=$projectID&orderBy=&type=closedbyme", $lang->product->closedByMe); echo  '</li>' ;
	echo "<li id='draftstoryTab'>"; common::printLink('project', 'story', "project=$projectID&orderBy=&type=draftstory", $lang->product->draftStory); echo  '</li>' ;
    echo "<li id='activestoryTab'>"; common::printLink('project', 'story', "project=$projectID&orderBy=&type=activestory", $lang->product->activeStory); echo  '</li>' ;
    echo "<li id='changedstoryTab'>"; common::printLink('project', 'story', "project=$projectID&orderBy=&type=changedstory", $lang->product->changedStory); echo '</li>' ;
	echo "<li id='willcloseTab'>"; common::printLink('project', 'story', "project=$projectID&orderBy=&type=willclose", $lang->product->willClose); echo  '</li>' ;
    echo "<li id='closedstoryTab'>"; common::printLink('project', 'story', "project=$projectID&orderBy=&type=closedstory", $lang->product->closedStory); echo '</li>' ;
    echo "<li id='uncreatetaskTab'>"; common::printLink('project', 'story', "project=$projectID&orderBy=&type=uncreatetask", $lang->kevindefine->unCreateTask); echo '</li>' ;
	?>
  </ul>
  <div class='actions'>
    <div class='btn-group'>
...
<div class='main'>
  <form method='post' id='projectStoryForm'>
    <table class='table tablesorter table-condensed table-fixed' id='storyList'>
      <thead>
        <tr class='colhead'>
        <?php $vars = "projectID={$project->id}&orderBy=%s&type=$type"; ?>
