...
<?php js::set('confirmDelete', $lang->kevinstore->confirmDelete); ?>
<!-- ECharts单文件引入 -->
	...
	<div class='side-body'>
		<div class='panel panel-sm'>
			...
			<div class='panel-body'>
				<ul class='tree'>
					<?php
					foreach ($this->lang->kevinstore->statisticType as $currentStatisticType => $currentStatisticName) {
						echo '<li>' . html::a(helper::createLink('kevinstore', 'statistic', "type=$currentStatisticType"), $currentStatisticName, '', "class='link'") ;
