...
<div id='featurebar'>
	...
	<ul class='nav'>
		...
		common::printLink('project', 'bug', "project=$projectID&orderBy=$orderBy&build=$buildID&recTotal=&recPerPage=&pageID=$pageID&type=unclosed", $lang->bug->unclosed);
		echo '</li>';
		echo "<li id='allbugsTab'>";
		common::printLink('project', 'bug', "project=$projectID&orderBy=$orderBy&build=$buildID&recTotal=&recPerPage=&pageID=$pageID&type=allbugs", $lang->bug->allBugs);
		echo '</li>';
		echo "<li id='assignedtomeTab'>";
		common::printLink('project', 'bug', "project=$projectID&orderBy=$orderBy&build=$buildID&recTotal=&recPerPage=&pageID=$pageID&type=assignedtome", $lang->bug->assignToMe);
		echo '</li>';
		echo "<li id='openedbymeTab'>";
		common::printLink('project', 'bug', "project=$projectID&orderBy=$orderBy&build=$buildID&recTotal=&recPerPage=&pageID=$pageID&type=openedbyme", $lang->bug->openedByMe);
		echo '</li>';
		echo "<li id='resolvedbymeTab'>";
		common::printLink('project', 'bug', "project=$projectID&orderBy=$orderBy&build=$buildID&recTotal=&recPerPage=&pageID=$pageID&type=resolvedbyme", $lang->bug->resolvedByMe);
		echo '</li>';
		echo "<li id='closedbymeTab'>";
		common::printLink('project', 'bug', "project=$projectID&orderBy=$orderBy&build=$buildID&recTotal=&recPerPage=&pageID=$pageID&type=closedbyme", $lang->bug->closedByMe);
		echo '</li>';
		echo "<li id='assigntonullTab'>";
		common::printLink('project', 'bug', "project=$projectID&orderBy=$orderBy&build=$buildID&recTotal=&recPerPage=&pageID=$pageID&type=assigntonull", $lang->bug->assignToNull);
		echo '</li>';
		echo "<li id='unresolvedTab'>";
		common::printLink('project', 'bug', "project=$projectID&orderBy=$orderBy&build=$buildID&recTotal=&recPerPage=&pageID=$pageID&type=unresolved", $lang->bug->unResolved);
		echo '</li>';
		echo "<li id='longlifebugsTab'>";
		common::printLink('project', 'bug', "project=$projectID&orderBy=$orderBy&build=$buildID&recTotal=&recPerPage=&pageID=$pageID&type=longlifebugs", $lang->bug->longLifeBugs);
		echo '</li>';
		echo "<li id='postponedbugsTab'>";
		common::printLink('project', 'bug', "project=$projectID&orderBy=$orderBy&build=$buildID&recTotal=&recPerPage=&pageID=$pageID&type=postponedbugs", $lang->bug->postponedBugs);
		echo '</li>';
		?>
	</ul>
	<div class='actions'>
