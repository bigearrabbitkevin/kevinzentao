...
<div id='titlebar'>
  <div class='heading'>
    <i class="icon-kevinsoft-fileedit icon-pencil"></i><span class='prefix'><?php echo html::icon($lang->icons['edit']);?></span>
    <strong><?php echo $lang->kevinsoft->ModifyKevinSoftFileName;?></strong>
  </div>
</div>
    ...
    <tr>
      <td>
        <div class='input-group'>
          <?php echo html::input('title', $file->title, "class='form-control'");?>
