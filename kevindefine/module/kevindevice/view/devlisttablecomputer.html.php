<table class='table table-condensed table-hover tablesorter ' id='deviceList'　 style="table-layout:fixed;">
	<thead>
		<tr>
			...
			<th class='w-80px'><?php common::printOrderLink('repairstart', $orderBy, $vars, $lang->kevindevice->repairstart); ?></th>
			<th class='w-80px'><?php common::printOrderLink('repairend', $orderBy, $vars, $lang->kevindevice->repairend); ?></th>
			<th class='w-100px'><?php common::printOrderLink('description', $orderBy, $vars, $lang->kevindevice->desc); ?></th>
		</tr>
	</thead>
	<tbody>
		...
		<?php foreach ($devices as $device): 
			...
			<tr class='text-center'">
				...
				<td style=<?php echo $endstyle?>><?php echo ($device->repairstart == "0000-00-00")? "":$device->repairstart; ?></td>
