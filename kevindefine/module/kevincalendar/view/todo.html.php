...
<div style="margin: 0" class="op-calendar-new">
	<?php
	$statusArray	 = $this->kevincalendar->getInofoByMonth($type, $controlType);
						...
						<tbody>
							...
							for ($index = 0; $index < 6; $index++) {
								...
								for ($weekday = 0; $weekday < 7; $weekday++) {
									$strTemp = '<td><div class = "div-kevincalendar-day ';
									...
									if ('C' == $type) {
										if ('hol' == $status) {
											$strTemp .= 'kevincalendar-day-S';
										} else if ('law' == $status) {
											$strTemp .= 'kevincalendar-day-H';
										} else if ('nor' == $status) {
											$strTemp .= 'kevincalendar-day-W';
										} else {
											$strTemp .= 'kevincalendar-day-otherMonth';
										}
									} else {
										$strTemp .= 'kevincalendar-day-otherMonth';
									}
